(function () {
    ...
    app.service('searchService', function ($window) {
        ...
        function download(roles, streets) {
            var queries = buildQuery(roles, streets);

            console.log(queries);

            openInNewPage('/api/places', queries);
        }

        function buildQuery(roles, streets) {
            var queries = [];

            roles.forEach(function (role) {
                streets.forEach(function (street) {
                    queries.push(role + ' in ' + street);
                })
            });
        ...
        function openInNewPage(url, queries) {
            ...
            mapInput.type = "text";
            mapInput.name = "queries";
            mapInput.value = angular.toJson(queries);
